...
export default function CartDrawer({ onCheckout }) {
  ...
  const { cartItems, totalItems, totalPrice, removeFromCart, updateQty, isOpen, closeCart } = useCart();
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ padding: "18px 24px", background: RUST, color: "#fff", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <h2 style={{ margin: 0, fontSize: "17px", fontWeight: "700", fontFamily: "'Stardom-Regular', serif" }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                        ...
                        <button
                          ...
                          disabled={atMax}
                          style={{ width: "24px", height: "24px", border: "1.5px solid #ddd", borderRadius: "6px", background: atMax ? "#f5f5f5" : "#fff", cursor: atMax ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", opacity: atMax ? 0.4 : 1 }}
                        >
                          <FiPlus size={11} />
                        </button>
                        {atMax && <span style={{ fontSize: "10px", color: "#e67e22", fontWeight: "700" }}>Max</span>}
        ...
        {cartItems.length > 0 && (
          <div style={{ padding: "18px 20px", borderTop: `1px solid ${BEIGE}` }}>
            ...
            <button
              style={{ width: "100%", padding: "13px", background: `linear-gradient(135deg, ${BROWN}, ${RUST})`, color: "#fff", border: "none", borderRadius: "12px", fontSize: "14px", fontWeight: "700", cursor: "pointer", letterSpacing: "0.5px", fontFamily: "'Stardom-Regular', serif" }}
              onClick={onCheckout}
            >
              Proceed to Checkout →
            </button>
